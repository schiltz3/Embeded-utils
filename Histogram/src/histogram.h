 ...
 * @brief Histogram containing pointers to HistogramCount, histogramPercent, BucketLimits, as well as the number of buckets and an error enum
 */
typedef struct
{
...
histogram_s *CreateHistogram(uint32_t *pBuckets, uint8_t *pHistogramPercent, uint32_t *pHistogramCount, uint8_t histogramLength);
